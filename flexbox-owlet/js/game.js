var game = {
  ...
  setHandlers: function() {
    $('#next').on('click', function() {
      ...
      $('.owl').addClass('animated bounceOutUp');
  ...
  loadLevel: function(level) {
    $('#editor').show();
    $('#share').hide();
    $('#background, #container').removeClass('wrap').attr('style', '').empty();
    $('#levelsWrapper').hide();
    ...
    for (var i = 0; i < string.length; i++) {
      ...
      var tree = $('<div/>').addClass('tree ' + color).data('color', color);
      var owl = $('<div/>').addClass('owl ' + color).data('color', color);

      $('<div/>').addClass('bg').appendTo(tree);
      $('<div/>').addClass('bg animated pulse infinite').appendTo(owl);

      $('#background').append(tree);
      $('#container').append(owl);
    }
  ...
  applyStyles: function() {
    ...
    var code = $('#code').val();
    var selector = level.selector || '';
    $('#container ' +  selector).attr('style', code);
    game.saveAnswer();
  },
  ...
  win: function() {
    ...
    $('#code').val(solution);
    $('#share').show();
    $('.owl .bg').removeClass('pulse').addClass('bounce');
  },
